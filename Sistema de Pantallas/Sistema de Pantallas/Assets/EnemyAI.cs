...
public class EnemyAI : MonoBehaviour
{
    ...
    void Update()
    {
        switch (currentState) //estado actual en el que se encuentra la AI del NPC
        {
            ...
            case State.Chase:
                ...
                {
                    //en cambio si no lo vemos sumamos tiempo hasta que superamos el valor de cooldown de persecución
    ...
    bool CanSeePlayer()
    {
        ...
        //y la proyección que estamos realizando no esta obstruida por un obstaculo
